...
- `Create Room`: tạo phòng có ID. Đánh dấu `Private room` để phòng không xuất hiện trong ghép ngẫu nhiên.
...
- `Join Room`: nhập ID để vào phòng cụ thể; bỏ trống ID để tìm một phòng công khai đang chờ.
